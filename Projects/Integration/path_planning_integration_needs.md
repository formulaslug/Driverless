# From Localization
Need a 2-d array of cone coordinates from local coordinate frames with coordinates relative to global map. Will also need color confidences of each cone as well as car pose with both coordinates and current estimated direction given as an angle relative to the global x-axis.
